...
- **Gate asociado:** precondición de G-28.
- **Estado inicial:** `BLOCKED`.
- **Estado actual:** `READY_FOR_AUDIT` — implementado el 2026-07-26, con corrección de auditoría aplicada el mismo día. Pendiente de **nueva** auditoría independiente antes de `PASSED`.
...
- **Validaciones ejecutadas tras la corrección (2026-07-26):**
  ...
  Esta tarjeta **permanece `READY_FOR_AUDIT`** — la corrección no se autocertifica como `PASSED`; requiere una nueva auditoría independiente que confirme `H-T03-01` y `L-T03-02` como `RESOLVED` antes de avanzar a `E5-S2-T04`.
...
- **Estado:** **`READY_FOR_AUDIT`** — implementada el 2026-07-30. Pendiente de **auditoría independiente `READ ONLY` con Codex** antes de `PASSED`. No se marca `PASSED`, no se habilita `E5-S2-T08` ni ninguna tarea posterior, no se crea auditoría final. Q-001 permanece **abierta**, sin relación con esta tarea.
