...
- **Estado inicial:** `BLOCKED`.
- **Estado actual:** `READY_FOR_AUDIT` (implementado 2026-07-31). **No `PASSED`.** _(Estado histórico previo, mismo día: `HABILITADA` / `NO INICIADA` — superado por la implementación registrada abajo.)_
