...
| Últimas tareas cerradas (`PASSED`)                                | **`E5-S3-T06`, `E5-S3-T07`, `EWO-SEC-NAV-001 T03` y `T04`** — las últimas dos cerradas tras reauditorías independientes `READ ONLY` sobre `6dc846d5cd40bbd4b13d21ad9ca6ff646dca5540`                                                                                                                                                                                                                                   |
| Cierre administrativo Sprint 4                                    | **`E5-S4-T01` y `E5-S4-T09`: `PASSED`** — auditorías independientes sobre `889f151ff92b0a1885be7ec55a274572a6c7e6df`; el hardening de T01 está integrado en main como `7eeefda014974215aecbcca482efcc6d922eda68` (cherry-pick equivalente). Evidencia: [`E5-S4-T01_FINAL_AUDIT.md`](docs/engineering/audits/E5-S4-T01_FINAL_AUDIT.md) y [`E5-S4-T09_FINAL_AUDIT.md`](docs/engineering/audits/E5-S4-T09_FINAL_AUDIT.md) |
...
| D-011 | `cfdi.read` para Auditor y Supervisor; `document.download` separado   | **IMPLEMENTADA · PASSED** — reauditoría independiente `READ ONLY` sobre `6dc846d5cd40bbd4b13d21ad9ca6ff646dca5540`; `cfdi.read` concedido a Auditor/Supervisor y `document.download` como clave independiente para Administrador/Contador/Auxiliar/Supervisor/Auditor. `API-0026` debe exigirla: `document.read` y `cfdi.read` nunca autorizan la descarga del binario |
| D-012 | Identidad canónica de CFDI mediante `documentId`                      | **IMPLEMENTADA · PASSED** — reauditoría independiente `READ ONLY` sobre `6dc846d5cd40bbd4b13d21ad9ca6ff646dca5540`; `T04` sincronizó `docs/14`, `docs/31`, `docs/32` y `EWO-005_DOCUMENTS_FISCAL_PLAN.md` a `/{companyId}/documentos/{documentId}/cfdi`                                                                                                                |
