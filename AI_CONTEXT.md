...
| D-012 | Identidad canónica de CFDI mediante `documentId`                      | **IMPLEMENTADA · PENDIENTE DE AUDITORÍA** (2026-08-04) — `T04` sincronizó `docs/14`, `docs/31`, `docs/32` y `EWO-005_DOCUMENTS_FISCAL_PLAN.md` a `/{companyId}/documentos/{documentId}/cfdi`                                                                                                                          |
